const fr = {
  translation: {
    ...
    history: {
      title: "Historique des resumes",
      clearAll: "Tout effacer",
      clearAllTitle: "Effacer tout l'historique ?",
      clearAllDescription: "Voulez-vous vraiment supprimer tous les resumes enregistres ?",
      summary: "resume",
      summaries: "resumes",
      willBeDeleted: "seront supprimes.",
      empty: "Aucun resume pour le moment. Generez-en un et il apparaitra ici.",
      open: "Ouvrir",
      remove: "Supprimer",
      removeTitle: "Supprimer ce resume ?",
      removeDescription: "Ce resume sera supprime definitivement de votre historique local.",
    },
    profile: {
      account: "Compte",
