const en = {
  translation: {
    ...
    summaryErrors: {
      ...
      actionInProgress: "An action is already in progress.",
      requestFailedTitle: "Request failed",
      generateFailed: "Could not generate action item.",
      emptyResponse: "The backend returned an empty response.",
      malformedTitle: "Malformed response",
      malformedMessage: "The server returned a response that could not be parsed.",
      networkErrorTitle: "Network error",
      networkErrorMessage: "Could not contact the backend. Please try again.",
      sourceReadTitle: "Could not read source",
      sourceReadMessage: "Could not read the current tab. Try reloading the page and trying again.",
      noActiveTabTitle: "No active tab",
      noActiveTabMessage: "Could not find an active browser tab.",
      restrictedPageTitle: "Page not supported",
      restrictedPageMessage: "Chrome internal pages (like chrome://settings) are not supported. Open a normal website tab and try again.",
      injectionBlockedTitle: "Cannot read this page",
      injectionBlockedMessage: "This page blocks extension script access. Try another site tab and try again.",
      noReadableContentTitle: "No readable content",
      noReadableContentMessage: "Could not extract readable text from this page.",
      pdfFileAccessTitle: "Local PDF access blocked",
      pdfFileAccessMessage: "Open chrome://extensions, find ReadToRecall, and enable \"Allow access to file URLs\", then try again.",
      pdfReadTitle: "Could not read PDF",
      pdfReadMessage: "Could not fetch this PDF. Try opening it in a fresh tab and reloading.",
    },
    exportErrors: {
      inProgress: "An export is already in progress.",
      noUrl: "No URL available for export.",
      failed: "Export failed.",
      requestFailed: "Export request failed ({{status}}).",
      webpageFailed: "Could not generate PDF from this webpage.",
      transcriptFailed: "Could not fetch transcript for this video.",
    },
  },
} as const;
